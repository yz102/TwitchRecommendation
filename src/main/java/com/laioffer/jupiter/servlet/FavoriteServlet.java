...
public class FavoriteServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (session == null) {
//            if session is invalid, 403
            response.setStatus(HttpServletResponse.SC_FORBIDDEN);
            return;
        }
//        know what is user id when login, read from session here
        String userId = (String) session.getAttribute("user_id");

//        String userId = request.getParameter("user_id");
//        jackson json -> java object
//        read request body and convert to java object
//        JSONObject is map
        //ObjectMapper mapper = new ObjectMapper();
//        the 2nd parameter indicates converting to what type of object
...
//            connect to mysql, setFavorite(user, item)
